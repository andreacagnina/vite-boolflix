...
export default {
    ...
    methods: {
        ...
        searchSeries() {
            store.searchSeries(this.searchQuery).then(seriesResults => {
...
<template>
    ...
    <div>
        <input class="me-2 p-1" v-model="searchQuery" placeholder="Cerca un film o una serie..."
            @keypress.enter="searchContent" />
