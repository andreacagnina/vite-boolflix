...
export default {
    ...
    methods: {
        // Creo una funzione con un parametro che mi switcha le lingue nel codice del paese (solo codici che non coincidono). Se non si ha un riscontro, ritorna il parametro che corrisponde alla lingua originale
...
<template>
    <!-- creo delle col che ciclo per ottenere una griglia, faccio delle card con img e descrizioni dei film. Vari div annidati e con il mouse over mi compaio le informazioni che altrimenti sono nascosti -->
    <div class="col-12 col-md-6 col-lg-3" v-for="item in store.seriesResults" :key="`movie-${item.id}`">
        <div class="card mt-4">
            ...
            <div class="hiddenCard">
                ...
                <div v-show="item.name !== item.original_name"><strong>Titolo originale:</strong> {{
